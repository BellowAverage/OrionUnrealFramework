...
public:
	...
	void ApproveCharaAttackOnActor(std::vector<AOrionChara*> OrionCharasRequested, AActor* TargetActor, FVector HitOffset, CommandType inCommandType);

	//UFUNCTION(BlueprintCallable, Category = "Gameplay Requests")
	bool ApproveCharaMoveToLocation(std::vector<AOrionChara*> OrionCharasRequested, FVector TargetLocation, CommandType inCommandType);

	//UFUNCTION(BlueprintCallable, Category = "Gameplay Requests")
	bool ApprovePawnMoveToLocation(std::vector<AWheeledVehiclePawn*> OrionPawnsRequested, FVector TargetLocation, CommandType inCommandType);

	//UFUNCTION(BlueprintCallable, Category = "Gameplay Requests")
	void ApproveInteractWithActor(std::vector<AOrionChara*> OrionCharasRequested, AOrionActor* TargetActor, CommandType inCommandType);
